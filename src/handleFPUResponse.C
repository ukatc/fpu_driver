                       ...
                       int &count_pending)
{
    ...
    case CCMD_CONFIG_MOTION                    : handler = &handle_ConfigMotion_response; required_length = 5; break;
    ...
    case CCMD_LOCK_UNIT                        : handler = &handle_LockUnit_response; break;
    case CCMD_UNLOCK_UNIT                      : handler = &handle_UnlockUnit_response; break;
    case CCMD_RESET_STEPCOUNTER                : handler = &handle_ResetStepCounter_response; break;
    case CCMD_GET_FIRMWARE_VERSION             : handler = &handle_GetFirmwareVersion_response; break;
    case CCMD_CHECK_INTEGRITY                  : handler = &handle_CheckIntegrity_response; break;
    case CCMD_FREE_ALPHA_LIMIT_BREACH          : handler = &handle_FreeAlphaLimitBreach_response; break;
    case CCMD_ENABLE_ALPHA_LIMIT_PROTECTION    : handler = &handle_EnableAlphaLimitProtection_response; break;
    case CCMD_SET_TICKS_PER_SEGMENT            : handler = &handle_SetTicksPerSegment_response; break;
    case CCMD_SET_STEPS_PER_SEGMENT            : handler = &handle_SetStepsPerSegment_response; break;
    case CCMD_ENABLE_MOVE                      : handler = &handle_EnableMove_response; break;
