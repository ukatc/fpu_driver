...
#include "ethercan/cancommands/ConfigureMotionCommand.h"
#include "ethercan/cancommands/EnableBetaCollisionProtectionCommand.h"
#include "ethercan/cancommands/ExecuteMotionCommand.h"
#include "ethercan/cancommands/FindDatumCommand.h"
#include "ethercan/cancommands/FreeBetaCollisionCommand.h"
#include "ethercan/cancommands/GetErrorAlphaCommand.h"
#include "ethercan/cancommands/GetErrorBetaCommand.h"
#include "ethercan/cancommands/GetStepsAlphaCommand.h"
#include "ethercan/cancommands/GetStepsBetaCommand.h"
#include "ethercan/cancommands/PingFPUCommand.h"
#include "ethercan/cancommands/ReadRegisterCommand.h"
#include "ethercan/cancommands/ReadSerialNumberCommand.h"
#include "ethercan/cancommands/RepeatMotionCommand.h"
#include "ethercan/cancommands/ResetFPUCommand.h"
#include "ethercan/cancommands/ReverseMotionCommand.h"
#include "ethercan/cancommands/SetUStepLevelCommand.h"
#include "ethercan/cancommands/WriteSerialNumberCommand.h"
        ...
        double &max_wait_time, bool &finished, t_fpuset const * const fpuset_opt)
{
...
#if (CAN_PROTOCOL_VERSION == 1)
    {
        ...
        for(int i = 0; i < config.num_fpus; i++)
        {
            ...
            {
                fprintf(stderr, "AsyncInterface: WARNING\b: findDatum() moved both arms in FPU %i,"
                        " arm selection ignored, this indicates version 1.0 firmware on FPU.\n",
                        i);
                LOG_CONTROL(LOG_ERROR, "%18.6f : AsyncInterface: WARNING: findDatum moved both"
...
E_EtherCANErrCode AsyncInterface::freeBetaCollisionAsync(int fpu_id, E_REQUEST_DIRECTION request_dir,
        t_grid_state& grid_state,
        E_GridState& state_summary)
{
    // first, get current state and time-out count of the grid
