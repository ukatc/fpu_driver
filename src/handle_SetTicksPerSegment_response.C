...
////////////////////////////////////////////////////////////////////////////////
// NAME handle_SetTicksPerSegment_response.C
//
...
void handle_SetTicksPerSegment_response(const EtherCANInterfaceConfig&config,
                                        const int fpu_id,
                                        t_fpu_state& fpu,
                                        ...
                                        const uint8_t sequence_number)
{
    ...
    if (response_errcode == 0)
    {
        ...
        LOG_RX(LOG_INFO, "%18.6f : RX : "
               "setTicksPerSegment command succeeded for FPU %i\n",
               get_realtime(),
               fpu_id);
    ...
    else
    {
        ...
        LOG_RX(LOG_ERROR, "%18.6f : RX : "
               "setTicksPerSegment command failed for FPU %i (errcode=%u)\n",
               get_realtime(),
