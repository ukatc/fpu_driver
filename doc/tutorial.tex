...
The associated error message and enumeration symbol should be sufficient to
...
message can be delayed by several minutes. This is by design
\textendash{} the socket connection by the normal TCP stack of the
operating system kernel and its parameters are optimized to complete
communications even on a highly unreliable connection.
