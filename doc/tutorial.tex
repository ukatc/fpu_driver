...
\begin{itemize}
\item Compatibility: This FPU driver version is compatible with
  firmware version 1.4.4 upwards. It is not backward-compatible with
  earlier firmware versions because the version code flag which is
  used to test safety of a number of operations is stored in a
  different place on the FPUs.
