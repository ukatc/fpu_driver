...
BOOST_PYTHON_MODULE(ethercanif)
{
    ...
    .value("DE_INTERFACE_STILL_CONNECTED",DE_INTERFACE_STILL_CONNECTED)
    .value("DE_WAVEFORM_NOT_READY", DE_WAVEFORM_NOT_READY)
    .value("DE_FPUS_NOT_CALIBRATED", DE_FPUS_NOT_CALIBRATED)
    ...
    // Database errors
    .value("DE_DB_ENV_VARIABLE_NOT_FOUND", DE_DB_ENV_VARIABLE_NOT_FOUND)
    .value("DE_DB_OPEN_DIR_OR_FILE_NOT_FOUND", DE_DB_OPEN_DIR_OR_FILE_NOT_FOUND)
    .value("DE_DB_OPEN_ACCESS_DENIED", DE_DB_OPEN_ACCESS_DENIED)
    .value("DE_DB_OPEN_OLD_FORMAT", DE_DB_OPEN_OLD_FORMAT)
    .value("DE_DB_OPEN_OTHER_FAILURE", DE_DB_OPEN_OTHER_FAILURE)
    .value("DE_DB_TRANSACTION_CREATION_FAILED", DE_DB_TRANSACTION_CREATION_FAILED)
    .value("DE_DB_MISSING_FPU_ENTRY_OR_READ_FAILED", DE_DB_MISSING_FPU_ENTRY_OR_READ_FAILED)
    .value("DE_DB_WRITE_FAILED", DE_DB_WRITE_FAILED)
    .value("DE_DB_SYNC_FAILED", DE_DB_SYNC_FAILED)
    // Unknown error
