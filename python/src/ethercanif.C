...
BOOST_PYTHON_MODULE(ethercanif)
{
    ...
    .value("DE_DB_DIR_OR_FILE_NOT_FOUND", DE_DB_DIR_OR_FILE_NOT_FOUND)
    .value("DE_DB_ACCESS_DENIED", DE_DB_ACCESS_DENIED)
    .value("DE_DB_OLD_FORMAT", DE_DB_OLD_FORMAT)
    .value("DE_DB_OTHER_OPENING_FAILURE", DE_DB_OTHER_OPENING_FAILURE)
