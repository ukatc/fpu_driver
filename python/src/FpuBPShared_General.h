...
// TODO: This Boost.Python enum_ sharing as a macro isn't very elegant (but
// works for now) - is there a better way? Would need to look more closely at
// the underlying code of Boost.Python, to see how its keywords
// (e.g. BOOST_PYTHON_MDOULE, enum_ etc) are defined, and how these could be
// possibly generated as instances of objects and extern'd into the required
// code (for example)? 

#define DEFINE_ENUM_E_LogLevel \
...
#define DEFINE_ENUM_EtherCANErrCode \
