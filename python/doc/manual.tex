...
resolved. In protocol version 2, this can be done more safely using
the \texttt{enableMove} command, so that it is not necessary to reset
or power-cycle the FPU.
...
page~\pageref{sec:moving_uninitialized_fpus}.
