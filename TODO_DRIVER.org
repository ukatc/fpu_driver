...
** TODO Lift waveform restriction for zero movement (DEFINE)
** TODO stress tests with multiple FPUs
** TODO translate thorpy driver to python2
** TODO Integrate path analysis script into MOONS shared library
** TODO Update tutorial on allowed waveforms
** TODO expand tutorial with reference part
** TODO add separate reporting/logging of results
** TODO Fix multiplexing of broadcast commands (currently, they are only sent to bus 0)
