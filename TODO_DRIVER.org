...
** TODO Install Scientific Linux or ESO Linux image on kraken
** TODO Add & test TCP options for socket connection time-outs.
** TODO Fix detection & reporting of CAN command timeouts
** TODO revise tutorial
*** TODO expand tutorial with reference part 
*** TODO apply spelling corrections to tutorial
*** TODO Tidy up error codes, and list them in tutorial reference
*** TODO List exception hierarchy in tutorial
*** TODO add runnable example scripts
*** TODO review NaN description
** TODO Add separate initialised flags for alpha and beta
** TODO extend list_angles to list initialized bit, document that
** TODO Add selection parameter for datum method
** TODO add separate reporting/logging of results
** TODO clarify requirement for variable MAX_FPU
** TODO move driver parameters to const struct
...
** TODO do a git-svn pull of library
...
* TODO make thorpy driver accessible in python2

** TODO read protocol for stages we have
** TODO get java environment
** TODO get turntable
** TODO Do PySerial experiments
