...
*** TODO fix torn paragraph in state machine description
*** TODO make wording of direction orientation more precise
*** TODO update Steven's picture on FPU motor ranges
*** TODO format serial number in printSerialNumbers() wird repr()
*** DONE install LMDB on moons-pc01
*** TODO read intro into LMDB usage
*** TODO install eigen on moons-pc01
