...
** TODO 0.5.4: Tutorial, fix description of findDatum option selected_arm
...
*** TODO discern SocketFailure from FPUTimeoutError
...
*** TODO add readRegister command
*** TODO add  readFirmwareVersion command
*** TODO test firmware version in findDatum command
*** TODO add addressing a subset of FPUs 
*** TODO add reporting of total number of steps
*** TODO add reporting number of movements
*** TODO document orientation in tutorial
