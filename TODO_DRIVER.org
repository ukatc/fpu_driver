...
*** TODO extend list_angles to list uninitialized angles or initialized bit, document that
*** TODO Add alpha/beta selection parameter for datum method
...
*** TODO Add log levels as discussed
