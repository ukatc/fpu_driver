...
** TODO fix underflow / overflow of step counter after reset in simulation code
** TODO take underflow / overflow value of step counter into account in protection layer
** TODO enhance abort error message for illegal step count:
*** TODO generate exception
*** TODO report offset
*** TODO report step counter
*** TODO report expected range
** TODO add version number to waveform validation code
** TODO Update lifetime test script to stricter waveform rule
** TODO add documentation for waveform ruleset versions
** TODO Add logging for protection layer:
*** TODO log start-up time
*** TODO log driver version
*** TODO log firmware versions
*** TODO log updated counter offsets on reset / start
** TODO check for CAN buffer overflow in MOC (HW/SW)
** TODO support configurable new storage location of FPU version number
