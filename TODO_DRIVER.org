...
** TODO check overflow error count, add print of total overflow count in wrapper
** TODO provide wait time configuration for configMotion command
...
** TODO fix bug with summed step counter
