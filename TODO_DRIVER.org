...
*** TODO extend spec to autoDatum and firmwareVersion flags
*** TODO control direction of datum command and add automatic datum flag
**** TODO test denial of auto with firmware < 1.2
**** TODO extend simfirmware to ignore beta, mirror flags
**** TODO test DASEL_ALPHA, DASEL_BOTH
**** TODO test SEARCH_AUTO, SEARCH_CLOCKWISE, SEARCH_ANTI_CLOCKWISE
**** TODO test protection flag (switch off denial)
**** DONE add readRegister command
**** DONE add  readFirmwareVersion command
**** DONE test firmware version in findDatum command
**** TODO document orientation ~ steps in tutorial
**** TODO document new exceptions for ProtectionError, TimeoutError
**** TODO document changes to findDatum
**** TODO document readRegister, getVersionInformation
*** TODO add reporting number of movements
*** TODO add reporting of total number of steps
*** TODO add addressing a subset of FPUs 
*** TODO  test AutoDatum
*** TODO pack release 0.6.0
