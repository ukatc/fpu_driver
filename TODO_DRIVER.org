...
** TODO Fix encoding of beta step count in both driver and mock_controller
** TODO fix message lengths in all version 1 CAN commands
** TODO fix changed CAN command names
...
** TODO add PingFPU  command
** TODO add resetFPU command
** TODO Add eventfds for new commands and for driver shutdown
** TODO Add time-outs for commands
** TODO revise expects_response field
** TODO add response handlers for base commands
...
*** TODO searchDatum
*** TODO leaveDatum
*** TODO print frequency of epoll / cond_wait calls
*** TODO solve argument passing of grid_state
*** TODO print invalid responses
