...
#ifndef HANDLE_ENABLE_BETA_COLLISION_PROTECTION_RESPONSE_H
#define HANDLE_ENABLE_BETA_COLLISION_PROTECTION_RESPONSE_H
...
{
void handle_EnableBetaCollisionProtection_response(const EtherCANInterfaceConfig&config,
        const int fpu_id,
        t_fpu_state& fpu,
        int &count_pending,
