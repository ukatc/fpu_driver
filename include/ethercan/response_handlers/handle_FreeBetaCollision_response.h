...
#ifndef HANDLE_FREE_BETA_COLLISION_RESPONSE_H
#define HANDLE_FREE_BETA_COLLISION_RESPONSE_H
...
{
void handle_FreeBetaCollision_response(const EtherCANInterfaceConfig&config,
                                       const int fpu_id,
                                       t_fpu_state& fpu,
                                       int &count_pending,
