...
#ifndef HANDLE_SET_USTEP_LEVEL_RESPONSE_H
#define HANDLE_SET_USTEP_LEVEL_RESPONSE_H
...
{
void handle_SetUStepLevel_response(const EtherCANInterfaceConfig&config,
                                   const int fpu_id,
                                   t_fpu_state& fpu,
                                   int &count_pending,
